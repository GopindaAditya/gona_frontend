    ...
    <aside className="w-64 bg-card-light dark:bg-card-dark flex flex-col p-4 border-r border-border-light dark:border-border-dark">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm">for Indonesian SMEs</p>
        </div>
      </div>
        ...
        {menu.map((item) => (
          <a
            ...
            className={cn(
              ...
              pathname === item.href && "bg-primary/20 dark:bg-primary/30"
            )}
          >
      ...
      <Button className="mt-4" variant="primary">Help</Button>
    </aside>
  );
}
